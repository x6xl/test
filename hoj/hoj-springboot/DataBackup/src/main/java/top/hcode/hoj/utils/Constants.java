...
public class Constants {
     ...
     */
    public enum File {
        EXAM_IMAGE_SHOT("E:\\gogo\\project\\HOJ/hoj/file/exam"),

        USER_AVATAR_FOLDER("E:\\gogo\\project\\HOJ/hoj/file/avatar"),

        GROUP_AVATAR_FOLDER("E:\\gogo\\project\\HOJ/hoj/file/avatar/group"),

        HOME_CAROUSEL_FOLDER("E:\\gogo\\project\\HOJ/hoj/file/carousel"),

        MARKDOWN_FILE_FOLDER("E:\\gogo\\project\\HOJ/hoj/file/md"),

        PROBLEM_FILE_FOLDER("E:\\gogo\\project\\HOJ/hoj/file/problem"),

        CONTEST_TEXT_PRINT_FOLDER("E:\\gogo\\project\\HOJ/hoj/file/contest_print"),

        IMG_API("/api/public/img/"),

        FILE_API("/api/public/file/"),

        TESTCASE_TMP_FOLDER("E:\\gogo\\project\\HOJ/hoj/file/zip"),

        TESTCASE_BASE_FOLDER("E:\\gogo\\project\\HOJ/hoj/testcase"),

        FILE_DOWNLOAD_TMP_FOLDER("E:\\gogo\\project\\HOJ/hoj/file/zip/download"),

        CONTEST_AC_SUBMISSION_TMP_FOLDER("E:\\gogo\\project\\HOJ/hoj/file/zip/contest_ac");
