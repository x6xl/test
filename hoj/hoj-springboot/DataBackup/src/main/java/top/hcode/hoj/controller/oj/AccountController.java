...
public class AccountController {
    ...
    @RequiresAuthentication  //要验证用户信息
    ...
    @PostMapping("/change-userInfo")//修改用户信息
    @RequiresAuthentication
    ...
    @GetMapping("/get-user-auth-info")//获取用户的认证信息
    @RequiresAuthentication
    ...
    @RequiresAuthentication
    public  CommonResult<String> userSignIn() throws StatusFailException {
        return accountService.userSignIn();
    }

    @GetMapping("/getUserSignInfo")
    public  CommonResult<String> getUserSignInfo(){
        return accountService.getUserSignInfo();
    }
}