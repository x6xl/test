export const m = {
  ...
  NavBar_Group: 'Group',
  NavBar_About: 'About',
  NavBar_Question: 'Question',
  NavBar_OptQuestion: 'OptQuestion',
  NavBar_exam: 'exam',
  ...
  Check_in_information: 'check in information',
  Click_the_Punch_button: 'click the punch button',
  Checked_in_today: 'checked in today',
  Check_in: 'check in',
  Exam_Notification: 'exam notification',
  New_exams:'new exams',
  update_Exams:'update exams',
  Failed_to_get_check_in_information: 'failed to get check in information',
  Failed_to_check_in: 'failed to check in',
  Failed_to_get_exam_notification: 'failed to get exam notification',

  //   /views/oj/problem/questionList.vue
  Opt_score: 'score',
  Opt_id: 'id',
  Opt_questionId: 'questionid',
  Opt_author: 'author',
  Opt_questionContent: 'questionContent',
  Opt_authorId: 'authorId',
  Opt_questionType: 'questionType',
  Opt_createTime: 'createTime',
  Opt_options: 'options',
  option_content: 'option content',

  search: 'Search',
  admin_Exam_Update:'updateExam',
  question_List:'questionList',
  Add_question:'AddQuestion',
  exam_manager:'examManager',
  Add_Problem_to_Exam:'AddProblemToExam',
  Please_enter_a_keyword: 'Please enter a keyword',
  Select_question_type: 'Select question type',
  All_questions: 'All questions',
  a_choice_questions: 'a choice questions',
  Multiple_choice_questions: 'Multiple choice questions',
  Judge_questions:'Judge questions',
  Code_questions:'Code questions',
  ...
  Review_The_Question_Option: 'Review The Question Option',
  Delete_The_Question: 'Delete The Question',
  Edit_The_Question:  'Edit The Question',
  Add_The_Question_To_Exam_Tip: 'Add The Question To Exam Tip',
  Add_The_Question_To_Exam: 'Add The Question To Exam',
  Add_Question_to_Exam:    'Add Question to Exam',
  Add_Problem_to_Exam_Tip: 'Add Problem to Exam Tip',
  Import_questions_files: 'To import questions, you can only import excel files',

  Exam_id: 'Exam ID',
  Exam_name: 'Exam Name',
  Exam_update:'Update Exam Information',
  Exam_add:'Create Exam Information' ,
  Exam_description: 'Exam Description',
  Exam_start_time: 'Exam Start Time',
  Exam_end_time: 'Exam End Time',
  Exam_score_radio: 'Exam Radio Score',
  Exam_score_check: 'Exam Check Score',
  Exam_score_fill: 'Exam Fill Score',
  Exam_score_code: 'Exam Code Score',
  Exam_score_judge: 'Exam Judge Score',
  Unknown_question_type: 'Unknown question type',
  Exam_password: 'Exam Password',
  Is_Join: 'Is Joined Exam',
  Question_bank: 'Question Bank',
  Page_data:'Displays paginated data',
  All_data:'Displays all data',

  Reset: 'reset',
  Add_question_option: 'add question option',
  create_successfully: 'create successfully',

  cancel: 'Cancel',
  confirm: 'Confirm',
  Please_select_at_least_one_question_to_use_for_the_exam: 'Please select at least one question to use for the exam',
  Please_enter_the_options_content: 'Please enter the options content',
  Add_Question_To_Exam: 'Add Question To Exam',

  add_exam_code_question: 'add exam code question',
  Delete_The_Exam: 'Delete The Exam',
  View_user_submission_records: 'view user submission records',
  Get_Exam_process_ShotImage: 'get exam process shot image',
  Exam_Detail: 'exam detail',
  Exam_Total_Score: 'exam total score',
  Exam_submission_records: 'exam submission records',
  Joiner_Id: 'joiner id',
  Join_time: 'join time',
  Exam_cost_Time:'exam cost time',
  Get_score: 'get score',
  Answer_option: 'answer option',
  Export_Excel: 'export excel',
  Exam_process_ShotImage:'exam process shot image',
  Exam_Create_Time:'exam create time',
  Exam_Update_Time:'exam update time',

  Exam_attentions:'Note: Do not close this page before submitting your exam!! Otherwise, it will be submitted automatically!!',
  Exam_Time :'exam time',
  Please_enter_your_email_address: 'please enter your email address',
  Getting_it: 'getting...',
  Get_Exam_password: 'get exam password',
  Please_enter_the_exam_password: 'please enter the exam password',
  Start_Exam: 'start exam',
  Please_enter_your_answer: 'please enter your answer',
  The_Question_Number1: 'Question',
  The_Question_Number2: ' ',
  Submit_Exam: 'submit exam',
  Your_Exam_Score: 'your exam score is',
  minutes: 'minutes',
  ...
  user_id: 'user id',
  Screenshots_of_the_exam_were_not_found:'screenshots of the exam were not found',
  Failes_to_get_exam_record: 'failes to get exam record',
  Failed_to_delete_exam: 'failed to delete exam',
  Failed_to_get_details_of_the_exam: 'failed to get details of the exam',
  failed_to_get_exam_list: 'failed to get exam list',
  export_success: 'export success',
  failed_to_get_details_of_the_question: 'failed to get details of the question',
  failed_to_get_options_of_the_question: 'failed to get options of the question',
  add_success: '添加成功',
  add_failed: '添加失败',
  prompt: '提示',
  Add_question_option: 'add question option',
  ...
  failed_to_get_question_list: 'failed to get questuin list',
  Leave_the_exam_reminder:'You haven\'t submitted your exam yet, do you want to leave and submit it automatically?',
  failed_to_get_exam_password: 'failed to get exam password',
  send_exam_password_success: 'send exam password success',
  Exam_password_has_been_sent: 'exam password has been sent to your email, please check it!',
  submit_exam_success: 'submit exam success',
  submit_exam_failed: 'submit exam failed',
  Not_selected: 'not selected',
  right: 'right',
  failed_to_get_exam_record: '获取考试记录失败',
  Programming_practice_and_exam_system: 'Programming Practice And Exam System',
  Desc:"Descending",
  Asc:"Ascending",
  Please_enter_userId_to_search: 'Please enter userId to search',
