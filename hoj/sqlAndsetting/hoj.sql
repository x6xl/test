...
CREATE TABLE `exam` (
                      ...
                      `exam_description` varchar(255) DEFAULT NULL COMMENT '考试描述',
                      `problem_id` varchar(255) DEFAULT NULL COMMENT '当前考试下的代码题id',
                      `question_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '当前考试下的题目的id用-连在一起地字符串',
                      `exam_score` int NOT NULL COMMENT '当前考试的总分数',
                      `exam_score_radio` int NOT NULL COMMENT '当前考试每个单选题的分数',
                      `exam_score_check` int NOT NULL COMMENT '当前考试每个多选题的分数',
                      `exam_score_fill` int NOT NULL COMMENT '当前考试每个填空题的分数',
                      `exam_score_code` int NOT NULL COMMENT '当前考试每个代码题的分数',
                      `exam_score_judge` int NOT NULL COMMENT '当前考试每个判断题的分数',
                      `exam_creator_id` varchar(255) NOT NULL COMMENT '考试创建者的用户id',
                      `exam_time_limit` int NOT NULL COMMENT '考试的时间限制，单位为分钟',
                      `exam_start_date` datetime NOT NULL COMMENT '考试有效期开始时间',
                      `exam_end_date` datetime NOT NULL COMMENT '考试有效期结束时间',
                      `create_time` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
                      `update_time` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
                      PRIMARY KEY (`exam_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

DROP TABLE IF EXISTS `exam_image_shot`;
CREATE TABLE `exam_image_shot` (
                                 `id` int NOT NULL AUTO_INCREMENT,
                                 `exam_id` varchar(32) DEFAULT NULL,
                                 `exam_joiner_id` varchar(255) DEFAULT NULL,
                                 `name` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `exam_password`;
CREATE TABLE `exam_password` (
                               `exam_id` varchar(32) NOT NULL COMMENT '考试id',
                               `password` varchar(255) DEFAULT NULL COMMENT '考试密码',
                               PRIMARY KEY (`exam_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

DROP TABLE IF EXISTS `exam_record`;
CREATE TABLE `exam_record` (
                             `exam_record_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '考试记录表的主键',
                             `exam_joiner_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '考试参与者的用户id',
                             `exam_join_date` datetime NOT NULL COMMENT '参加考试的时间',
                             `exam_time_cost` int NOT NULL COMMENT '完成考试所用的时间,单位分钟',
                             `exam_join_score` int NOT NULL COMMENT '参与考试的实际得分',
                             `exam_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '题目id',
                             `answer_option_ids` varchar(255) DEFAULT NULL,
...
CREATE TABLE `question_content` (
                                  `id` int NOT NULL AUTO_INCREMENT,
                                  `question_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '题目的id',
                                  `author` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '发布者',
                                  `author_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '发布者id',
                                  `question_score` int DEFAULT NULL COMMENT '该题母的分数',
                                  `question_type` int DEFAULT NULL COMMENT '题目类型，1为单选题、2为多选题、3为判断题、4为填空题、5为简答题、6为代码编程题',
                                  `question_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '题目内容',
                                  `right_answer` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '题目答案',
                                  `create_time` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '创建题目时间',
                                  PRIMARY KEY (`id`)
...
CREATE TABLE `question_feedback` (
                                   `id` int NOT NULL AUTO_INCREMENT,
                                   `question_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '题目id',
                                   `user_id` varchar(255) NOT NULL COMMENT '用户id',
                                   `question_type` int DEFAULT NULL COMMENT '题目类型，1为单选题、2为多选题、3为判断题、4为填空题、5为简答题、6为代码编程题',
                                   `question_score` int DEFAULT NULL COMMENT '题目的分数',
                                   `judge_result` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT '判题结果',
...
CREATE TABLE `question_options` (
                                  ...
                                  `id` int NOT NULL AUTO_INCREMENT,
                                  `author` varchar(255) DEFAULT NULL COMMENT '出题者',
                                  `author_id` varchar(255) DEFAULT NULL COMMENT '出题者id',
                                  `option_content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci COMMENT '选项内容',
                                  PRIMARY KEY (`id`)
...
CREATE TABLE `question_submission` (
                                     ...
                                     `question_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '题目id',
                                     `user_id` varchar(255) NOT NULL COMMENT '用户id',
                                     `question_type` int NOT NULL COMMENT '题目类型，1为单选题、2为多选题、3为判断题、4为填空题、5为简答题、6为代码编程题',
                                     `submit_time` datetime NOT NULL COMMENT '用户提交时间',
                                     `submit_result` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '用户提交的答案',
                                     PRIMARY KEY (`id`)
