    ...
    <el-row :gutter="18">
      <el-col :sm="24" :md="18" :lg="18">
        <el-card shadow>
          ...
          <el-table-column prop="questionContent" :label="$t('m.Opt_questionContent')" width="200" class-name="el-table-column--questionContent"></el-table-column> 
...
.el-table-column--questionContent {
    overflow: hidden;
    white-space: nowrap;
