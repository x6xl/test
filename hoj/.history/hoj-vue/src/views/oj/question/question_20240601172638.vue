         ...
         .then(response => {  
           ...
           api.getFeedback(params.questionId)
            .then(getFeedbackResponse => {  
              console.log('反馈666');  
              this.result=getFeedbackResponse.data.data;
              this.judgeResult = getFeedbackResponse.data.data.judgeResult;
              this.userAnswer = getFeedbackResponse.data.data.userAnswer;
              console.log('urrrrr', this.result);
              console.log('useranser:', this.userAnswer);
