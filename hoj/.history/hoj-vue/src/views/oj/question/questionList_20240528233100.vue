<template>
    <el-row :gutter="18">
      <el-col :sm="24" :md="18" :lg="18">
        <el-card shadow>
          ...
          <el-table-column prop="questionContent" :label="$t('m.Opt_questionContent')" width="200" :show-overflow-tooltip='true'>
          </el-table-column> 
  ...
  export default {  
    ...
    methods: {  
      ...
      // 假设你有一个名为QuestionDetail的路由，并且它接受一个id作为参数  
      this.$router.push({ name: 'question', params: { id: row.id } });
