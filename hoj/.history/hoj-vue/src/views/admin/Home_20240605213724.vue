    ...
    <div v-if="!mobileNar">
      ...
      >
        ...
        <el-submenu index="question">
          <template slot="title"
            ><i class="el-icon-circle-plus fa-size" aria-hidden="true"></i
            >题库</template
          >
          <el-menu-item index="/admin/questions">问题列表</el-menu-item>
          <el-menu-item index="/admin/question/add">问题创建</el-menu-item>
          <!-- <el-menu-item index="/admin/problem/tag">其他</el-menu-item>
           <el-menu-item index="/admin/group-problem/apply"
           v-if="isSuperAdmin || isProblemAdmin"
           >{{$t('m.Admin_Group_Apply_Problem')}}
           </el-menu-item>
        ...
        <mu-list toggle-nested>
          ...
          >
            ...
            <mu-list-item
              ...
              active-class="mobile-menu-active"
            >
              <mu-list-item-title>问题创建</mu-list-item-title>
            </mu-list-item>
             <!--<mu-list-item
              v-if="isSuperAdmin || isProblemAdmin"
              button
