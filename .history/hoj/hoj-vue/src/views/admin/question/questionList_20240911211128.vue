<template>
      ...
      <div slot="header">
        <el-row :gutter="20" style="margin-bottom: 0.5em;">
          ...
          <el-col :xs="4" :sm="6" class="text-right">
            ...
            <el-tooltip content="导入题目,只能导入excel文件" placement="top">
              <el-upload
  ...
  <el-col :span="6" class="text-right">
    <el-button @click="toggleShowAll">{{ showAll ? '显示分页数据' : '显示所有数据' }}</el-button>
  </el-col>
</el-row>
...
export default {
  ...
  computed: {
    examActionText() {
      ...
      return this.$route.name === 'admin-examUpdate' ? '编辑考试' : '创建考试';
    },
    examDialogTitle() {
