<template>  
    <div>  
      ...
      <el-form-item :label="$t('m.Opt_options')" v-if="questionType === '2'">
        <el-checkbox-group v-model="form.selectedAnswers" @change="updateSelectedOptionContent(option.optionContent)">
          <el-checkbox
            v-for="option in question.options"
            :key="option.id"
            :label="option.optionContent"
