...
export default {
  ...
  methods: {
    ...
    getQuestionTypeLabel(type) {
      const types = {
        '1': this.$message.error(this.$t('m.a_choice_questions')),
        '2': this.$message.error(this.$t('m.Multiple_choice_questions')),
        '3': this.$message.error(this.$t('m.Judge_questions')),
        '4': this.$message.error(this.$t('m.Fill_questions'))
      };
