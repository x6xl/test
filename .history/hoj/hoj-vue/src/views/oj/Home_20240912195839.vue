<template>
  ...
  <div slot="header" class="clearfix title">
    <span class="home-title panel-title">
      <i class="el-icon-thumb"></i>签到信息
    </span>
  </div>

  <div class="card-content" style="text-align: center;">
    <p style="color: orange; font-size: 24px;">{{ currentDate }}</p>
    <p v-if="!isSignedIn" style="font-size: 18px;">点击打卡按钮</p>
    <p v-else style="font-size: 18px;">今天已签到</p>

    <el-button v-if="!isSignedIn" @click="signIn" style="margin-top: 10px;">打卡</el-button>
  </div>
</el-card>
        ...
        <el-card class="card-top">
          ...
          <div v-for="notice in examNoticeList" :key="notice.examId" style="margin-bottom: 20px;">
            ...
            <p>考试ID: {{ notice.examId }}</p>
            <p>考试时间: {{ formatExamTime(notice.examStartDate, notice.examEndDate) }}</p>
          </div>
        </el-card>
