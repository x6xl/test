...
export const m = {
  ...
  Click_the_Punch_button: '点击打卡按钮',
  Checked_in_today: '今日已签到',
  Check_in: '签到',
  Exam_Notification: '考试通知',
  New_exams:'新增考试',
  update_Exams:'更新考试',
  Failed_to_get_check_in_information: '获取签到信息失败',
  Failed_to_check_in: '签到失败',
  Failed_to_get_exam_notification: '获取考试通知失败',
...
//   /views/oj/problem/questionList.vue
  ...
  Opt_questionId: '题号',
  Opt_author: '出题人',
  Opt_questionContent: '题目内容',
  Opt_authorId: '出题人id',
  Opt_questionType: '题目类型',
  Opt_createTime: '出题时间',
  Opt_options: '选项',
  option_content: '选项内容',
  ...
  Add_question:'创建题目',
  exam_manager:'考试管理',
  admin_Exam_Update:'考试编辑',
  Exam_update:'编辑考试信息',
  Exam_add:'创建考试信息',
  Add_Exam:'创建考试',
  Add_Problem_to_Exam:'添加考试代码题',
  Please_enter_a_keyword: '请输入关键字',
  Select_question_type: '选择题目类型',
  All_questions: '所有题目',
  a_choice_questions: '单选题',
  Multiple_choice_questions:'多选题',
  Judge_questions:'判断题',
  Code_questions:'代码题',
  Fill_questions:'填空题',
  Unknown_question_type: '未知类型',
  Right_answer: '正确答案',
  Operate: '操作',
  update: '更新',
  Selected: '选中',
  Review_The_Question_Option: '查看题目选项',
  Delete_The_Question: '删除该题目',
  Edit_The_Question: '编辑该题目',
  Add_The_Question_To_Exam_Tip: '请选择考试代码题',
  Add_The_Question_To_Exam: '添加该题目到考试',
  Add_Question_to_Exam: '添加题目到考试',
  Add_Problem_to_Exam_Tip: '请选择考试代码题',
  Import_questions_files: '导入题目,只能导入excel文件',
  Page_data:'显示分页数据',
  All_data:'显示所有数据',
  ...
  Exam_end_time: '结束时间',
  Exam_score_radio: '考试单选题分数',
  Exam_score_check: '考试多选题分数',
  Exam_score_fill: '考试填空题分数',
  Exam_score_code: '考试代码题分数',
  Exam_score_judge: '考试判断题分数',
  Exam_password: '考试密码',
  Unknown_question_type: '未知类型',
  Is_Join: '是否参加过',

  Reset: '重置',
  Add_question_option: '添加题目选项',
  ...
  cancel: '取消',
  confirm: '确定',
  Please_select_at_least_one_question_to_use_for_the_exam: '请至少选择一道题目用于考试',
  Please_enter_the_options_content: '请输入选项选项',
  Add_Question_To_Exam: '添加题目到考试',

  add_exam_code_question: '添加考试代码题',
  Delete_The_Exam: '删除考试',
  View_user_submission_records: '查看用户提交记录',
  Get_Exam_process_ShotImage: '获取考试过程截图',
  Exam_Detail: '考试详情',
  Exam_Total_Score: '考试总分',
  Exam_submission_records: '考试提交记录',
  Joiner_Id: '提交者id',
  Join_time: '加入考试时间',
  Exam_cost_Time:'考试用时',
  Get_score: '得分',
  ...
  Exam_process_ShotImage:'考试过程截图',
  Exam_Create_Time:'考试创建时间',
  Exam_Update_Time:'考试更新时间',
  Desc:"降序",
  Asc:"升序",
  Please_enter_userId_to_search: '请输入用户Id搜索',



  Exam_attentions:'注意：提交考试前请勿关闭此页面！！！否则将自动提交！！！',
  Exam_Time :'考试时间',
  Please_enter_your_email_address: '请输入您的邮箱地址',
  Getting_it: '获取中...',
  Get_Exam_password: '获取考试密码',
  Please_enter_the_exam_password: '请输入考试密码',
  Start_Exam: '开始考试',
  Please_enter_your_answer: '请输入您的答案',
  The_Question_Number1: '第',
  The_Question_Number2: '题',
  Submit_Exam: '提交考试',
  Your_Exam_Score: '您的考试分数为：',
  minutes: '分钟',
  Exam_Result: '考试结果',
  User_Answer: '用户答案',
  Result: '结果',
  ...
  view_result: '查看结果',
  user_id: '用户id',
  Screenshots_of_the_exam_were_not_found:'未找到考试过程截图',
  Failes_to_get_exam_record: '获取考试记录失败',
  Failed_to_delete_exam: '删除考试失败',
  Failed_to_get_details_of_the_exam: '获取考试详情失败',
  failed_to_get_exam_list: '获取考试列表失败',
  export_success: '导出成功',
  failed_to_get_details_of_the_question: '获取题目详情失败',
  failed_to_get_options_of_the_question: '获取题目选项失败',
  add_success: '添加成功',
  add_failed: '添加失败',
  prompt: '提示',
  failed_to_get_question_list: '获取题目列表失败',
  Leave_the_exam_reminder:'您还没有提交考试，是否确定要离开并自动提交考试？',
  failed_to_get_exam_password: '获取考试密码失败',
  send_exam_password_success: '发送考试密码成功',
  Exam_password_has_been_sent: '考试密码已发送至邮箱，请注意查收！',
  submit_exam_success: '提交考试成功',
  submit_exam_failed: '提交考试失败',
  Not_selected: '未选中',
  right: '正确',
  failed_to_get_exam_record: '获取考试记录失败',
  Programming_practice_and_exam_system: '编程练习与考试系统',
