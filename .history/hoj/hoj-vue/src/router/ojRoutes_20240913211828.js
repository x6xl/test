...
import QuestionList from '../views/oj/question/questionList.vue'
import question from "../views/oj/question/question.vue"
import examList from "../views/oj/question/examList.vue"
import exam from "../views/oj/question/exam.vue"
import ExamRecord from '../views/oj/question/examRecord.vue'
...
const ojRoutes = [
  ...
  {
    path: '/examRecord/:examId',
    name: 'examRecord',
    component: ExamRecord,
    meta: { title: 'exam Record Detail' }
  },
  {
    path: '/ExamProblem/:problemID',
    name: 'examProblemDetail',
    component: Problem,
    meta: { title: 'exam Problem Detail' }
  },
