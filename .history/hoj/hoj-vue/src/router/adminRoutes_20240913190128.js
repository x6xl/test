import ExamList from '../views/oj/question/examList.vue'
...
const question= ()=>import('@/views/admin/question/question')
const questionList= ()=>import('@/views/admin/question/questionList')
const exam= ()=>import('@/views/admin/question/exam')
const examList= ()=>import('@/views/admin/question/examList')
const Problem1= ()=>import('@/views/oj/problem/Problem.vue"')
const adminRoutes= [
    {
      path: '/admin/login',
      name: 'admin-login',
    ...
    },
    {
      ...
      },
      {
        ...
        {
          path: '/exam/:examId',
          name: 'admin-examDetail',
          component: exam,
          meta: { title: 'admin Exam Detail' }
        },
 
        {
          path: '/exam-update/:examId',
          name: 'admin-examUpdate',
          component: questionList,
          meta: { title: 'admin Exam Update' }
        },

        {
          path: 'exam/add-problem/:examId',
          name: 'admin-exam-add-problem',
          component: ProblemImportAndExport,
          meta: { title:'Add Problem to Exam'},
        },
        {
