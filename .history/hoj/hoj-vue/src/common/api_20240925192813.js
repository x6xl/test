...
const ojApi = {
  ...
  userSignIn(){
    return ajax('/api/user-signIn', 'post') 
  },
  getUserSignInfo(){
    return ajax('/api/getUserSignInfo', 'get')
  },


   //获取问题内容
  getQuestion(id) {
    return ajax('/api/question/getContent', 'get', {
      params: {
        id
      }
    })
  ...
  //获取问题列表 
  getQuestionList() {
    return ajax('/api/question-getContentList', 'get')
  },

  getQuestionListPage(limit,currentPage,keyword) {
    return ajax('/api/question-getContentListPage', 'get',{
      params: {
  ...
  getOptions(questionId) {
    return ajax('/api/question/getoptions', 'get', {
      params: {
  ...
  //提交
  addSubmissionOptions(data) {
    return ajax("/api/question/addSubmission", 'post', {
      data:data
    })
  },
  //判题
  judgeOpt(questionId) {
    return ajax('/api/question/judgeOpt', 'post', {
      params: {
        question_id:questionId
      }
    })
 ...
 //反馈
  getFeedback(questionId) {
    return ajax('/api/question/getFeedback', 'get', {
      params: {
        question_id:questionId
      }
    })
   ...
   //管理页面
  //获取问题列表 
  admin_getQuestionList() {
    return ajax('/api/admin/question/get-question-list', 'get')
  },
  
  //问题选项
  admin_getOptions(questionId) {
    return ajax('/api/admin/question/get-options', 'get', {
      params: {
        question_id:questionId
      }
    })
  ...
  //分页搜索问题列表
  admin_getQuestionListPage(limit,currentPage,keyword,questionType) {
    return ajax('/api/admin/question/get-question-list-page', 'get',{
      params: {
        limit,currentPage,keyword,questionType
      }
    })
  },
  //搜索
  admin_getQuestionListFind(searchKeyword) {
    return ajax('/api/admin/question/get-question-list-find', 'get',{
      params: {
        keyword:searchKeyword
      }
    })
  },
  admin_getQuestion(questionId) {
    return ajax('/api/admin/question/get-questionByQid', 'get', {
      params: {
        question_id:questionId
      }
    })
...
//删除
  admin_deleteQuestion(questionId) {
    return ajax('/api/admin/question/delete-questionByQid', 'post', {
      params: {
        question_id:questionId
      }
    })
  },
admin_deleteOption(id) {
    return ajax('/api/admin/question/delete-option', 'post', {
      params: {
        id:id
      }
    })
...
//添加问题
admin_addQuestion(data) {
  return ajax("/api/admin/question/add-question", 'post', {
    data:data
  })
},  
//更新问题
admin_updateQuestion(data) {
  return ajax("/api/admin/question/update-question", 'post', {
    data:data
  })
},  
...
//填空题的
//删除
admin_deleteFillQuestion(questionId) {
  return ajax('/api/admin/question/delete-fillQuestionByQid', 'post', {
    params: {
      question_id:questionId
    }
  })
...
//添加
admin_addFillQuestion(data) {
  return ajax("/api/admin/question/add-fillQuestion", 'post', {
    data:data
  })
},
//修改
admin_updateFillQuestion(data) {
  return ajax("/api/admin/question/update-fillQuestion", 'post', {
    data:data
  })
}, 
...
//获取考试记录列表
  getExamRecordList(){
    return ajax('/api/exam/RecordList', 'get')
  },

//获取考试列表
getExamList(){
    return ajax('/api/exam-List', 'get')
  },

getExamRecordList(examId,sort,keyword){
   return ajax('/api/admin/question/exam-record-List', 'get',{
    params: {
      exam_id:examId,
      sort:sort,
      keyword:keyword
...
//获取考试
  getExam(examId,password){
    return ajax('/api/get-exam', 'get',{
      params: {
        exam_id:examId,
        password:password
      }
  ...
  examGetProblemId(examId){
    return ajax('/api/exam-getProblemId', 'get',{
      params: {
        exam_id:examId
      }
    })
  ...
  //提交考试改卷
finishExam(examId,data) {
    return ajax('/api/finish-exam', 'post', {
      params: {
       exam_id:examId
      },
      data: data
  ...
  getExamRecord(examId){
    return ajax('/api/exam/RecordDetail', 'get',{
      params: {
        exam_id:examId
      }
    })
  ...
  admin_getExam(examId){
    return ajax('/api/admin/question/get-exam', 'get',{
      params: {
        exam_id:examId
      }
    })
...
//创建考试
admin_createExam(data) {
  return ajax("/api/admin/question/exam-create", 'post', {
    data:data
  })
}, 

//更新考试
admin_updateExam(data) {
  return ajax("/api/admin/question/exam-update", 'post', {
    data:data
  })
},  
...
//管理员端获取考试列表
admin_getExamList(){
  return ajax('/api/admin/question/exam-List', 'get')
},


admin_examDelete(examId){
  return ajax('/api/admin/question/exam-delete', 'post',{
    params: {
      exam_id:examId
    }
  })
...
//获取考试代码题id
admin_ExamGetProblemId(examId){
  return ajax('/api/admin/question/exam-getProblemId', 'get',{
    params: {
      exam_id:examId
    }
  })
...
//添加考试代码题
admin_examAddProblem(data) {
  return ajax("/api/admin/question/exam-addProblem", 'post', {
    data:data
  })
}, 


ExamSentPassword(data){
  return ajax('/api/exam-sentPassword', 'post',{
    data:data
  })
},

getExamRecordExcel(examId){
  return ajax('/api/admin/question/get-examRecord-excel', 'get',{
    params: {
      exam_id:examId
    }
  },'blob')
  ...
  getExamNotice(){
  return ajax('/api/exam-notice', 'get')
  },


getExamAllImageShot(examId){
    return ajax('/api/examImage/get-examAllImageShot', 'get',{
      params: {
        exam_id:examId
      }
    })
